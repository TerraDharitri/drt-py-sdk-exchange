...
def get_contract_retrieval_labels(contracts: str) -> List[str]:
    labels = []
    base_labels = [config.REWA_WRAPS, config.LOCKED_ASSETS, config.SIMPLE_LOCKS_ENERGY, 
...
def fetch_states(context: Context, args) -> json:
    ...
    if args.system_account == "offline":
        ...
        system_account_address = "drt1llllllllllllllllllllllllllllllllllllllllllllllllllls9258a4"
