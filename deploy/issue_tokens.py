...
from dharitri_py_sdk import ProxyNetworkProvider, Address, TokenPayment, Transaction
from dharitri_py_sdk.core.transaction_builders import ContractCallBuilder, DefaultTransactionBuildersConfiguration
    ...
    def issue_token():
        for i in range(0, args.num_tokens):
            ...
            builder = ContractCallBuilder(
                ...
                value=TokenPayment.rewa_from_integer(value)
            )
