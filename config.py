...
# Used net
DEFAULT_PROXY = "https://devnet-gateway.dharitri.com"                     # Proxy to be used for ALL operations
DEFAULT_API = "https://devnet-api.dharitri.com"                           # API to be used for ALL operations
...
DEFAULT_ISSUE_TOKEN_PRICE = 50000000000000000                               # 0.05 REWA - change only if different setup on nets
...
SF_DEX_REFERENCE_ADDRESS = "drt1qqqqqqqqqqqqqpgqq66xk9gfr4esuhem3jru86wg5hvp33a62jpsh4nhal"
...
REWA_WRAP_BYTECODE_PATH = DEFAULT_WORKSPACE.absolute() / "wasm" / "rewa-wrap.wasm"
...
PROXY_V2_BYTECODE_PATH = DEFAULT_WORKSPACE.absolute() / "wasm" / "proxy_dex_xmoa.wasm"
...
STAKING_V3_BYTECODE_PATH = "https://github.com/dharitri/drt-exchange-sc/releases/download/v3.1.1/farm-staking.wasm"
...
STAKING_PROXY_V3_BYTECODE_PATH = "https://github.com/dharitri/drt-exchange-sc/releases/download/v3.0.8/farm-staking-proxy.wasm"
...
FARM_V3_BYTECODE_PATH = "https://github.com/dharitri/drt-exchange-sc/releases/download/v3.1.1/farm-with-locked-rewards.wasm"
GOVERNANCE_BYTECODE_PATH = "https://github.com/dharitri/drt-exchange-sc/releases/download/v3.0.8/governance-v2.wasm"
POSITION_CREATOR_BYTECODE_PATH = "https://github.com/dharitri/drt-exchange-tools-sc/releases/download/v1.0.0-rc3/auto-pos-creator.wasm"
LOCKED_TOKEN_POSITION_CREATOR_BYTECODE_PATH = "https://github.com/dharitri/drt-exchange-tools-sc/releases/download/v1.0.0-rc3/locked-token-pos-creator.wasm"
ESCROW_BYTECODE_PATH = DEFAULT_WORKSPACE.absolute() / "wasm-v3" / "lkmoa-transfer.wasm"
LK_WRAP_BYTECODE_PATH = DEFAULT_WORKSPACE.absolute() / "wasm-v3" / "locked-token-wrapper.wasm"
COMPOSABLE_TASKS_BYTECODE_PATH = "https://github.com/dharitri/drt-exchange-tools-sc/releases/download/v1.0.0-rc3/composable-tasks.wasm"


# ------------ Generic configuration below; Modify only in case of framework changes ------------ #
TOKENS_CONTRACT_ADDRESS = "drt1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzllls6prdez"
SF_CONTROL_ADDRESS = "drt1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqplllskzf8kp"
ZERO_CONTRACT_ADDRESS = "drt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq85hk5z"
...
DEFAULT_MINT_VALUE = 1  # REWA      # TODO: don't go sub-unitary cause headaches occur. just don't be cheap for now...
